...
const Index = () => {
  return <main className="min-h-screen marble-bg">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-12">
        ...
        {/* Main Illustration */}
        <figure className="relative w-full max-w-5xl fade-in" style={{
        animationDelay: "0.3s"
      }}>
          <div className="relative overflow-hidden rounded-sm shadow-elegant">
            <img src={barcelonaChair} alt="Barcelona Chair assembly diagram - exploded view showing chrome frame, leather cushions, and hardware components in Portal game instructional style" className="w-full h-auto object-contain" />
